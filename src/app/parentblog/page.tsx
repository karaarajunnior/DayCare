...
export default function BlogPage() {
  ...
  const categories = ['All', 'Development', 'Nutrition', 'Behavior', 'Learning', 'Health'];

  const blogPosts = [
    {
      id: 1,
      title: '10 Ways to Encourage Early Reading',
      excerpt: 'Discover proven strategies to foster a love of reading in your child from an early age...',
      category: 'Learning',
    ...
    },
    {
      ...
      excerpt: 'Learn why tantrums happen and effective techniques for managing difficult moments...',
      category: 'Behavior',
    ...
    },
    {
      ...
      excerpt: 'Creative and nutritious snack ideas that are both delicious and good for growing bodies...',
      category: 'Nutrition',
    ...
    },
    {
      ...
      excerpt: 'What to expect during this crucial developmental period and when to seek professional advice...',
    ...
    },
    {
      ...
      excerpt: 'Establish healthy sleep routines that benefit the whole family and support child development...',
      category: 'Health',
    ...
    },
    {
      ...
      excerpt: 'Why pretend play is crucial for cognitive and social development in early childhood...',
      category: 'Learning',
    ...
    },
    {
      ...
      excerpt: 'Practical tips and strategies for parents struggling with selective eating habits...',
      category: 'Nutrition',
    ...
    },
    {
      ...
      excerpt: 'Step-by-step approach to successful potty training with patience and positivity...',
      category: 'Development',
    ...
    },
    {
      ...
      excerpt: 'Guidelines for appropriate screen time and creating healthy digital habits for young children...',
      category: 'Health',
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-600">
            Tips, insights, and guidance from our team of early childhood experts
          </p>
        </div>
          ...
          <Card className="overflow-hidden hover:shadow-2xl transition-all border-2 border-green-200">
            <div className="grid md:grid-cols-2">
              ...
              <CardContent className="p-8 flex flex-col justify-center">
                <Badge className="w-fit mb-3 bg-green-600">{blogPosts[0].category}</Badge>
          ...
          <Card className="bg-gradient-to-r from-green-600 to-emerald-600 text-white border-0">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg mb-6 text-green-50">
                Subscribe to our newsletter for weekly parenting tips and resources
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-xl transition-all cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">Building reading skills from birth</p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-all cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">Developing friendships and empathy</p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-all cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600">Encouraging critical thinking</p>
              </CardContent>
            </Card>
          </div>
        </section>
