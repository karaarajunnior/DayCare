...
// 								<Button className="hidden md:block">Enroll Now</Button>
// 							</Link>
// 							<button
...
// 								<p className="text-gray-600">info@damakids.edu</p>
// 							</div>
...
// 								<p className="text-gray-600">Visit us for a tour</p>
// 							</div>
// 						</div>
// 					</div>
// 				</div>
...
// 								</div>
// 								<div>
// 									<h3 className="font-bold text-lg">DAMAKIDS</h3>
...
// 						<p>
// 							&copy; 2025 DAMAKIDS Early Childhood Centre. All rights reserved.
// 						</p>
// 					</div>
// 				</div>
// 			</footer>
			...
			<nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm shadow-sm z-50">
				<div className="container mx-auto px-4 py-4">
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center gap-4">
							<Link href="/enrollment">
								{/* FIX: Removed 'hidden md:block' so button is visible on ALL devices */}
						...
						<div className="md:hidden py-4 border-t">
							<div className="flex flex-col space-y-3">
								...
								<div className="px-4 pt-2">
									<Link 
                                        href="/enrollment"
                                        // Ensure menu closes when button is clicked
                                        onClick={() => setMobileMenuOpen(false)} 
                                    >
										{/* FIX: Set button to full width and removed hiding classes */}
